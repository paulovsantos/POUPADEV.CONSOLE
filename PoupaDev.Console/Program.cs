...
var notasTurmas = new List<int> {10, 5, 2, 3, 10, 4, 3, 2, 5, 1, 4};

var existeNota1 = notasTurmas.Any(n => n == 1);
var primeiraNota10 = notasTurmas.First(n => n == 10);
var singleNota1 = notasTurmas.Single(n => n == 1);
var max = notasTurmas.Max();
var min = notasTurmas.Min();
var sum = notasTurmas.Sum();
var media = notasTurmas.Average();
...
using PoupaDev.Console.Entities;
...
void ObterDetalhes() {
   ...
   Console.WriteLine(objetivo.ImprimirResumo());
}
...
public class ObjetivoFinanceiro {
    ...
    public virtual void ImprimirResumo() {
        Console.WriteLine($"Objetivo {Titulo}, Valor: {ValorObjetivo}, com Saldo Atual: {Saldo}");
    }
}
